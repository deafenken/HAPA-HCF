...
parser.add_argument('--lambda1', type=float, default=10.0, help='loss weight lambda1 (alignment)')
parser.add_argument('--lambda2', type=float, default=10.0, help='loss weight lambda2 (fusion MIL)')
parser.add_argument('--lambda3', type=float, default=0.001, help='loss weight lambda3 (triplet)')
parser.add_argument('--lamda1', dest='lambda1', type=float, help='deprecated alias of --lambda1')
parser.add_argument('--lamda2', dest='lambda2', type=float, help='deprecated alias of --lambda2')
parser.add_argument('--lamda3', dest='lambda3', type=float, help='deprecated alias of --lambda3')